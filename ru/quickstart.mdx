...
Обратите внимение, что диаризация - более ресурсоемкая операция, чем транскрибация. Поэтому, время выполнения запроса может быть больше, чем при транскрибации. Поэтому стоимость минуты аудио при диаризации - 0,72 ₽ / мин.
