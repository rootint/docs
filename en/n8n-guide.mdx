...
3.  **Configure Body Parameters:**
    ...
    - Set the **Parameter Type** to `n8n Binary File`.
...
4.  **Done! (Add Optional Parameters):**
    ...
    - Make sure a node _before_ this HTTP Request node reads your audio file and makes its binary data available (usually in the `data` field).
