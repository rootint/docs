...
Note that performing speaker diarization is more computationally intensive than just transcribing an audio file, so the delay for the response will be longer.
